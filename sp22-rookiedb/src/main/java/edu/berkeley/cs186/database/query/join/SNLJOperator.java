...
public class SNLJOperator extends JoinOperator {
    ...
    private class SNLJIterator implements Iterator<Record> {
        ...
        private BacktrackingIterator<Record> rightSourceIterator; /**可以回溯，回到标记点**/
         ...
         *
         * 返回应该从该连接产生的下一条记录或者null如果没有更多记录供连接
         */
        private Record fetchNextRecord() {
            ...
            while(true) {
                if (this.rightSourceIterator.hasNext()) {
                    ...
                    this.leftRecord = leftSourceIterator.next(); /**advance left表，reset right表*/
